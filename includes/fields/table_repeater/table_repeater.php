<?php
add_action('foreman_render_table_repeater', 'foreman_render_table_repeater', 10, 4);
function foreman_render_table_repeater($render_type, $obj, $field, $editable=true) {
...
add_filter('foreman_validate_table_repeater', 'foreman_validate_table_repeater', 10, 2);
function foreman_validate_table_repeater($value, $field) {
  $db_version = array();
