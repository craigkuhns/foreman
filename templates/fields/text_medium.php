...
<div class="input">
  <?php if ($editable == true) { ?>
    <input class="text-medium" type="text" name="<?php echo foreman_field_name($field, $parent, $position) ?>" id="<?php echo foreman_field_id($field, $parent, $position) ?>" value="<?php echo $value ?>" />
  <?php } else { ?>
