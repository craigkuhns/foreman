...
<div class="input">
  <?php if ($editable == true) { ?>
    <textarea class="textarea-small" type="text" name="<?php echo foreman_field_name($field, $parent, $position) ?>" id="<?php echo foreman_field_id($field, $parent, $position) ?>"><?php echo $value ?></textarea>
  <?php } else { ?>
